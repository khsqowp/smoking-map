...
public class AdminService {
    ...
    public DashboardResponseDto getDashboardData() {
        ...
        return DashboardResponseDto.builder()
                ...
                .periodPlacesCount(todayPlacesCount)
                .placesGrowthRate(0.0) // DTO에 필요하므로 기본값 추가
                .usersGrowthRate(0.0)  // DTO에 필요하므로 기본값 추가
                .newPlacesChartData(java.util.Collections.emptyMap()) // DTO에 필요하므로 기본값 추가
                .newUsersChartData(java.util.Collections.emptyMap())  // DTO에 필요하므로 기본값 추가
                .build();
    }
}
